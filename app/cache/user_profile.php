            ...
            <div class="text-end">
                ...
                <div class="flex-shrink-0 dropdown">
                    ...
                    <ul class="dropdown-menu text-small shadow" style="">
                        ...
                        <li><a class="dropdown-item" href="http://127.0.2.36/auth/accounts/User/2/settings">Settings</a></li>
                        <li><a class="dropdown-item" href="http://127.0.2.36/auth/accounts/User/2">Profile</a></li>
